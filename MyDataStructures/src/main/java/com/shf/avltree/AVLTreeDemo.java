...
//        int[] arr = {4,3,6,5,7,8};
        ...
        System.out.println("输的左子树高度="+avlTree.getRoot().leftHeight());
        System.out.println("输的有子树高度="+avlTree.getRoot().rightHeight());
    }
}
...
//        当添加完成一个节点后，如果（左子树的高低压-右子树的高度）>1,右旋转
