package com.shf.tree.ThreadedBinaryTree;

import com.shf.tree.BinaryTreeDemo;
import lombok.Data;
...
//        测试线索化
        ...
        System.out.println("使用线索化的方式遍历 遍历线索化二叉树");
...
//    如果leftType==0 表示指向的是左子树，如果1则指向前驱节点
